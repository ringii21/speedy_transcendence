...
const ChatConv = ({ me, selectedChat }: ChatChannelProps) => {
  ...
  const [messages, setMessages] = React.useState(selectedChannel.data?.messages || [])

  if (selectedChannel.isLoading) return <span className='loading loading-lg'></span>
  ...
  return (
    <div className='flex flex-col'>
      <div className='flex items-center'>
        {selectedChannel.data.channelType === 'public' && <HiHashtag size={12} />}
