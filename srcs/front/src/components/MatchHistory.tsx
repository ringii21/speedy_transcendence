    ...
    <div className='hero-overlay relative bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 drop-shadow-md rounded-lg bg-opacity-60'>
      <div className='hero-content text-center text-neutral-content'>
        <div className='w-full pt-4'>
          ...
          <div className='flex flex-col m-6 pt-4 scroll rounded-lg overflow-y-auto scrollbar-track-transparent scrollbar-thumb-gray-900 scrollbar-thin scrollbar-thumb-rounded-md'>
            <table role='table'>
              <thead>
                <tr role='row'>
