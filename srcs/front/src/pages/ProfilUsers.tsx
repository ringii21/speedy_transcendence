...
// const ProfilUsers: React.FC<ProfilUsersWithNavbar> = ({ FakeUsers }: { FakeUsers: IUser[] }) => {
...
//     setUserData((current) => {
//       if (current) {
//         const newFriends = current.friends.filter((users) => users !== current.id)
...
//         return (
//           <button
//             onClick={userData?.friends.includes(userToFollow?.id) ? handleUnfollow : handleFollow}
...
//               <img src={userData ? userData.image : 'Loading...'} alt='myimage' />
//             </div>
//           </div>
